...
/**
 * A reusable alert component for notifications and important messages
 */
const Alert = ({ 
  title,
  message, 
  ...
  return (
    <div className={`border-l-4 p-4 mb-4 ${alertStyles[type].container}`}>
...
Alert.propTypes = {
  ...
  /** Alert type that determines styling */
