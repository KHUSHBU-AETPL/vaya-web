...
import vayaLogo from '../assets/Logo_Vaya!.png'; // Updated path to use assets directory
  ...
  return (
    <footer className="bg-primary-beige py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex">
              <div className="flex w-full shadow-sm rounded-md overflow-hidden">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border-none rounded-l-md focus:outline-none"  style={{ fontSize: 'var(--font-size-medium)', lineHeight: 'var(--line-height-medium)', color: 'var(--color-gray-100)', fontWeight: 'var(--font-weight-medium)' }}
                />
                <button className="bg-primary-orange text-white px-6 py-3 hover:bg-opacity-90 transition-colors" style={{ fontSize: 'var(--font-size-medium)', lineHeight: 'var(--line-height-medium)', fontWeight: 'var(--font-weight-medium)' }}>
        ...
        {/* Logo & Legal */}
        <div className="border-t pt-8 mt-8" style={{ borderColor: 'var(--color-gray-25)' }}>
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <img src={vayaLogo} alt="VAYA!" className="h-10" />
            </div>
            <div style={{ fontSize: 'var(--font-size-small)', lineHeight: 'var(--line-height-small)', color: 'var(--color-black)' }}>
