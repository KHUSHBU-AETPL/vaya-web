  ...
  return (
    <section className="bg-primary-beige py-16 lg:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-4xl lg:text-5xl font-extrabold leading-tight text-primary-dark mb-6">
          Any questions? We got you. {/* TODO(i18n): "Any questions? We got you." */}
        </h2>
        <p className="text-lg text-primary-dark-gray max-w-2xl mx-auto mb-12">
        ...
        {/* More FAQ's Link */}
        <a href="#" className="inline-flex items-center text-primary-orange font-semibold mt-12 group">
...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm cursor-pointer" onClick={toggleOpen}>
      <div className="flex justify-between items-center">
        ...
        <FaChevronDown className={`text-primary-dark-gray text-xl transform transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`} />
      </div>
      <div className={`mt-4 text-primary-dark-gray text-left ${isOpen ? 'block' : 'hidden'}`}> {/* This div will be toggled to show/hide the answer */}
